...
if __name__ == "__main__":
    ...
    if args.model in ['KNNDiv', 'DistReg', 'KNN', 'RF', 'GBC', 'RR', 'baseline']:
        ...
        if args.model == 'KNNDiv':
            ...
            train_score, test_score = train_sklearn_moments(
                X_tr, y_tr, X_ts, y_ts, name=name, model=args.model,
                imputation=args.imputation, missing_indicator=args.missing_indicator)
